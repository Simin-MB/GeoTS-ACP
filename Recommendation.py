...
def read_training_data():
    ...
    # Default setting: time is partitioned to WT and LT.
...
def read_ground_truth():
    ...
    result_dir = "/content/drive/MyDrive/GeoTS-ACP_model/Gowalla_data_quarter/result/result_dir"
    temp_dir = "/content/drive/MyDrive/GeoTS-ACP_model/Gowalla_data_quarter/result/temp_dir"
...
def main(result_dir, temp_dir):
    ...
    TAMF.train(sparse_training_matrices, temp_dir, max_iters=1, load_sigma=False)
...
if __name__ == '__main__':
    ...
    #print("======= RUNNING FOR BETA = ", beta_value, ", DATASET = ", data_name, ", SOCIAL CHECKIN OVERLAP = ", overlap_value, "========")

    #data_name == 'gowalla':
    #data_dir = "/content/drive/MyDrive/GeoTS-ACP_model/Gowalla_data_quarter"

    size_file = "/content/drive/MyDrive/GeoTS_model /Gowalla_dataset/Gowalla_data_size.txt"
    check_in_file = "/content/drive/MyDrive/GeoTS_model /Gowalla_dataset/Gowalla_checkins.txt"
    train_file = "/content/drive/MyDrive/GeoTS_model /Gowalla_dataset/Gowalla_train.txt"
    tune_file = "/content/drive/MyDrive/GeoTS_model /Gowalla_dataset/Gowalla_tune.txt"
    test_file = "/content/drive/MyDrive/GeoTS_model /Gowalla_dataset/Gowalla_test.txt"
    poi_file = "/content/drive/MyDrive/GeoTS_model /Gowalla_dataset/Gowalla_poi_coos.txt"
    social_file = "/content/drive/MyDrive/GeoTS_model /Gowalla_dataset/Gowalla_social_relations_70.txt"
    # else:
    ...
    tmp_dir_name = "/content/drive/MyDrive/GeoTS-ACP_model/Gowalla_data_quarter/result/tmp/tmp_dir_name/tmp_{}_{}/".format(data_name, beta_value)
    result_dir_name = "/content/drive/MyDrive/GeoTS-ACP_model/Gowalla_data_quarter/result/result_dir_name/result_{}_{}/".format(data_name, beta_value)
    try:
